...
| [`ft_04`](../../src/simple_agents/conformance/checks.py#L1332) | Counts held-out examples carrying `expects_absence` in the results file. `_absence_waived` needs `allow_unknown=False` on every model-calling node, which a `Maybe[...]` record does not have |
