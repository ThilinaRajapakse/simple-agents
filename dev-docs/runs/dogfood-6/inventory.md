...
| **DF6-I14** | `DocumentIndex` has no incremental add, so the project holds its own vector store and uses the library's index for the lexical half only, rebuilt per query | `DF6-D14` | add | item | — | scheduled P3-73 |
