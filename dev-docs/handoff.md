...
suspension `0.5`, shelf `0.1`, conversation `0.2`. Five dogfoods have run; [`runs/dogfood-protocol.md`](runs/dogfood-protocol.md#L1) is the protocol.
