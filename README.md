...
| [`docs/view.md`](docs/view.md) | `simple-agents view`: one page showing the project as it stands, for the builder: what is built, what is planned, what changed, where everything flows, and every prompt it sends. |
